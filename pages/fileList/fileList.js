...
Page({
  ...
  onLoad: function(options) {
    ...
    //
    wx.request({
      url: 'http://120.26.174.202:8080//carmanage/CarInfo/listFile',
      data: {},
      method: 'GET',
      header: {
  ...
  XmLonlinePreview: function(r) {
    ...
    //将文件名传到后台获取连接，然后在线预览
    wx.request({
      url: 'http://120.26.174.202:8080//carmanage/CarInfo/findFilesURL?fileName=' + r.currentTarget.dataset.dir + r.currentTarget.dataset.id,
      method: 'GET',
      data: {},
      header: {
