...
Page({
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: 'http://120.26.174.202:8080/carmanage/CarInfo/updateCar?projectName=' + projectName + "&vin=" + carvin + "&borrower=" + borrower + "&id=" + this.data.id + "&configuration=" + configuration + "&state=" + state,
      method: 'GET',
      data: {},
